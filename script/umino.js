...
import { cart, addToCart, removeCartItem } from "../feature/cart.js";
...
document.querySelectorAll(".js-add-to-cart").forEach((button) => {
  button.addEventListener("click", () => {
    const productId = button.dataset.productId; //productId is changed from data-product-id
    addToCart(productId);
    // console.log(cart);
    updateCartUI();
    ...
    //       <button class="decrease js-decrease-quantity" data-decrease-id='${matchingProduct.Id}' name="buttonName" aria-label="decrease">
    ...
    //       <button class="increase js-increase-quantity" data-decrease-id='${matchingProduct.Id}' name="buttonName" aria-label="increase">
    ...
    // `;
    // updateCartQuantity();
    // document.querySelector(".cart-item-list").appendChild(container);
  });
});
...
document.querySelectorAll(".js-remove-item").forEach((button) => {
  button.addEventListener("click", () => {
    const productId = button.dataset.matchingId;
...
//     button.addEventListener("click", () => {
//       const productId = button.dataset.decreaseId;
//       // const  = document.querySelector(`.js-decrease-btn-${productId}`);
